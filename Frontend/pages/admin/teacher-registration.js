        ...
        <>
            ...
            <div className='w-[99%]'>
                <div className='relative text-slate-700 m-20 w-5/12 mx-auto rounded-xl shadow-xl border border-blue-700'>
                    ...
                    <h1 className="text-center mt-12 mb-6 text-2xl font-medium">Teacher Registration Form</h1>
                    <form className='w-[80%] mx-auto px-2'>
                        ...
                        <div className="w-full mb-6 group">
                            ...
                            <input type="text" name="regId" id="regId" className="p-2 border-b-2 block focus:border-blue-500 focus:outline-none w-full" minlength="10" maxlength="10" placeholder='E2K2020XXXX' required />
                        </div>
                        ...
                        <button className='px-2 py-3 bg-gradient-to-r from-blue-500 to-indigo-700 w-full rounded-lg text-white mb-12'>Create  Teacher Account</button>
                    </form>
