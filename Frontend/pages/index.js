    ...
    <div className="w-[96vw] mx-auto h-screen">
      ...
      <div className="flex w-full">
        <div className="w-1/2 flex flex-col justify-center items-center">
          ...
          <p className='text-center text-lg m-4 text-gray-600'>Alpha is a "Cloud Based Attendace Tracker" system allows to keep a students attendace and records from anywhere in the world.</p>
          ...
          <Link href="/login" className="w-1/4 h-12">
